...
/*const typeNumber = prompt('Entrez un chiffre :')

if (typeNumber > 0) {
    console.log(`${typeNumber} est positif`)
} else {
    console.log(`${typeNumber} est négatif`)
}*/
...
/*const bonjour = prompt('Bonjour, je discute que avec les gens polis.')
let name

if (bonjour === 'Bonjour') {
    name = (prompt("Toi, tu es poli, tu me dis bonjour, je veux bien te parler… Comment t-appelles-tu ?"))
} else{
    console.log("TU N'ES PAS POLIS")
}
...
if (nombre > 0) {
    ...
    console.log(`${nombre} est négatif ou null`)
}*/
...
const BMIJohn = tailleJohn * (poidsJohn * poidsJohn)
